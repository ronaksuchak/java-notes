...
public class CollectionUtils {
	public static List<Product> populateData() {
		...
		products.add(new Product(100, "mango", FRUITS, parse("2020-05-01"), 500));
		...
		products.add(new Product(30, "rice", GRAINS, parse("2019-08-13"), 520));
		...
		return products;//rets growable product list to the caller.
	}
}
