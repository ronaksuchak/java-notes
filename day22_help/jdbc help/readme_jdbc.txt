...
eg : java.sql.Connection --i/f sun supplied
Imple class provided by MySQL -- com.mysql.cj.jdbc.Connection.class
...
For DBDA lab PC  -- jdbc:oracle:thin:@localhost:1521:xe
