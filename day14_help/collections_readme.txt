...
1.6 ArrayList(Collection<? extends E> coll)
Creates populated AL from ANY Collection(AL/LL/Vector/HS/LHS/TS).
eg : LinkedList<Emp> l1=new LinkedList<>();
l1.add(e1);......e10
AL<Emp> l2=new AL<>(l1);
for(Emp e : l2)
 sop(e);
...
void addAll(Collection<? extends E> e) -- bulk append operation
eg : l1 --- AL<Emp>
l1.addAll(.....);
AL,LL,Vector --- legal
HS,TS,LHS --legal
...
3. AccountValidations : validation rules
4. Tester : UI / ArrayList 
...
1.4 Accept src id , dest id & amt to transfer.
...
c -   instance of the class which has implemented compare method.(or implemented Comparator i/f)
