...
eg : Organize following in suitable class hierarchy(under "inh" package) : tight encapsulation
...
override : taste
method definition : sweet in taste
...
eg -- Use it in  sub classes. (override toString to display Account or Point2D or Emp details or Student / Faculty )
--------------------------
...
Emp e1=new Mgr(....);//legal --- abstract super cls ref ----> concrete sub class object
