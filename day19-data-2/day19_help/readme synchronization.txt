...
updateBalance n checkBalance :critical sections
...
To avoid race condition / guard critical section/s , you apply synchronization.

Using synchronized keyword , a lock is applied at the object level.
...
4. Blocking trigger 
unable to acquire lock(enter monitor) 
Un blocked -- monitor free.(synchronized method rets or synchrinized block over)
